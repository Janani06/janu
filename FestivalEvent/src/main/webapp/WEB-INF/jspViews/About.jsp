...
<head>
<title>Welcome to Event Registration System</title>
		...
		<tr>
			<td>
				<div id="header">
					&nbsp;
					<div align="center">
						<a href="<jstlcore:url value="logIn.html"/>"> Event
				...
				<table>
					<tr>
						...
						<td>
							<div id="content">
								<p>ERS, or the Event Registration System, is
									provided as a free service of the CodeXCalibur Society, to the citizens and visitors of the city of
									TrisKul. ERS allows ease of use to view and registration to
									various events and activities in the Triskul area.</p>
								<br />
								<p>ERS was created in a joint with Cognizant and BLT, Ltd and the
								...
								<p align="center" style="font-family: calibri; color: #6666CC;">Please
									note that any events or activities that are schedule via the
									 Event Registration System are subject to postponement
